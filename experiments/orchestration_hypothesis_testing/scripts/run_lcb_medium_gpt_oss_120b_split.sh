...
# LCB-medium pipeline with a real held-out split:
...
SRC_DIR="${SRC_DIR:-data/lcb_medium_gpt_oss_120b_split}"
OUTPUT_DIR="${OUTPUT_DIR:-data/final_confidence_bayes_quality_lcb_medium_gpt_oss_120b}"
LOG_DIR="${LOG_DIR:-logs/lcb_medium_gpt_oss_120b_split}"
...
echo
echo "===== train-only calibration: LCB medium candidates ====="
run "${calib_args[@]}"
...
echo "src_dir=${SRC_DIR}"
echo "output_dir=${OUTPUT_DIR}"
echo "actions=${OUTPUT_DIR}/lcb_medium/${GENERATOR}/controller_actions.jsonl"
echo "log_file=${LOG_FILE}"
